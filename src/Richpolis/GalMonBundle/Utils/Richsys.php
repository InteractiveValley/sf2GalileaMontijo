...
namespace Richpolis\GalMonBundle\Utils;
     ...
     static public function getArchivoViewLinkVideo(array $opciones2){
        ...
        $video_link=(isset($opciones2['archivo'])?$opciones2['archivo']:$opciones['archivo']);
         if(preg_match('/youtube\.com\/watch/i',$video_link)){
           $texto='<iframe src ="http://www.youtube.com/embed/'.sfRichSys::getVideoIdYoutube($video_link).'?rel=1&autoplay={autoplay}" width="{width}px" height="{height}px" frameborder="no"></iframe>';
